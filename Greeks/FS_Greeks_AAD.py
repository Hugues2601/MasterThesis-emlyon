...
K= torch.tensor([120], device=CONFIG.device)
T0 = torch.tensor([0], device=CONFIG.device)
T1 = torch.tensor([5], device=CONFIG.device)
T2 = torch.tensor([8], device=CONFIG.device)
T = torch.tensor([3], device=CONFIG.device)
